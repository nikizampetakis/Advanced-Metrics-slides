...
author: "Nikiforos Zampetakis based on slides from Florian Oswald"
date: "SciencesPo Paris </br> `r Sys.Date()`"
output:
  xaringan::moon_reader:
    lib_dir: lib
    css: [default, "C:/Users/nikzm/Documents/GitHub/Advanced-Metrics-slides/css/scpo.css", "C:/Users/nikzm/Documents/GitHub/Advanced-Metrics-slides/css/scpo-fonts.css"]
    nature:
      beforeInit: ["C:/Users/nikzm/Documents/GitHub/Advanced-Metrics-slides/js/ru_xaringan.js"]
...
<div class="my-footer"><img src="C:/Users/nikzm/Documents/GitHub/Advanced-Metrics-slides/img/logo/ScPo-shield.png" style="height: 60px;"/></div> 
...
p_load(broom, latex2exp, ggplot2, ggthemes, viridis, dplyr, magrittr, knitr, parallel, imager)
# Define pink color
scpo_red <- "#d90502"
# Knitr options
opts_chunk$set(
...
* I I combine theoretical models, *data and econometrics* to try answer these questions.
...
clusterExport(clust, c("pop_df", "n_s"))
clusterEvalQ(clust, c({library("tidyverse")}, {library("broom")}))
# Simulation
set.seed(12468)
sim_df <- parLapply(clust, x.list, fun = function(x, size = n_s) {
...
```{R, simulation scatter, echo = F, dev = "png", dpi = 300, cache = F,eval = T}
# Reshape sim_df
line_df <- tibble(
...
```{R, simulation scatter import, echo = F, dev = "png", dpi = 50, out.width = "800px", cache = F,eval = T}
knitr::include_graphics("C:/Users/nikzm/Documents/GitHub/Advanced-Metrics-slides/lectures/01-recap/recap1_files/figure-html/simul_scater.png")
```
---
# Population *vs.* sample
...
.pull-left[
```{R, simulation scatter2, echo = F, dev = "png", dpi = 300, cache = F,eval = T}
# Reshape sim_df
# ggplot() +
...
```{R, simulation scatter2 import, echo = F, dev = "png", dpi = 50, out.width = "450px", cache = F,eval = T}
knitr::include_graphics("C:/Users/nikzm/Documents/GitHub/Advanced-Metrics-slides/lectures/01-recap/recap1_files/figure-html/simul_scater.png")
```
]
