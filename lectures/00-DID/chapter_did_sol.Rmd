...
* Next week we will look at __Instrumental Variables__.
...
knitr::include_graphics("nj_penn_map.jpg")
```
]
...
4.Compute average FTE employment, average percentage of FT employees and average starting wage (wage_st) by state and by survey wave.
```{r, eval = FALSE, echo=TRUE}
library(skimr)
...
knitr::include_graphics("min_wage_parallel_trends.png")
```
