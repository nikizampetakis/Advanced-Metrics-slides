...
* We did a quick intro into causality and Rubin's Causal Model.

* We saw a situation where $\mathop{\boldsymbol{E}}\left[ u | X \right] = 0$ is violated (OVB).

* We discussed the interpretation of coefficients under different variables' types.

* Finally we scratched the surface of dealing with uncertainty and statical testing for inference.
